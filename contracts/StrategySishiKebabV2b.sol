...
contract StrategySishiKebabV2b {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    using Math for uint256;

    address public constant want = address(0x7979F6C54ebA05E18Ded44C4F986F49a5De551c2);
    address public constant wbnb = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    address public constant cakeChef = address(0x76FCeffFcf5325c6156cA89639b17464ea833ECd);
